...
import { collection, getDocs, doc, orderBy, query, getDoc } from 'firebase/firestore';
        ...
        <>
            <tbody className='text-white'>
                {problems.map((problem, idx) => {
                    const diffulyColor = problem.difficulty == "Easy" ? "text-dark-green-s" : problem.difficulty === "Medium" ? "text-dark-yellow" : "text-dark-pink";
                    return (
                        <tr className={`${idx % 2 == 1 ? "bg-dark-layer-1" : ""}`} key={problem.id}>
                            ...
                            <td className={`px-6 py-4 ${diffulyColor}`}>{problem.difficulty} </td>
